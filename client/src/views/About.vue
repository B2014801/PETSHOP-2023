<template>
    <div class="container text-center my-2">
        ...
        <img :src="imgs.about.bia1" alt="" />
        <p>
            Tại đây, chúng tôi có sẵn đa dạng các dòng chó mèo cảnh, khách hàng có thể đến lựa chọn và đón ngay thú cưng
            về nhà.
        </p>
        <img :src="imgs.about.bia2" alt="" />
        <p>Bên cạnh đó chúng tôi cũng bán kèm đa dạng các loại phụ kiện dành cho thú cưng của bạn</p>
        <img :src="imgs.about.bia3" alt="" />
    </div>
</template>
